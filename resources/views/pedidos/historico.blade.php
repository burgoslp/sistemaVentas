...
<div class="py-6 sm:px-6 lg:px-8">
    <div class="bg-white shadow sm:rounded-lg p-6">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-semibold mb-4">historico de Pedidos</h2>
            <a href=""
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($pedidos as $pedido)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">{{$pedido->approved_at}}</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap flex gap-4">
                                    <a href="{{route('pedidos.show',$pedido->id)}}" class="inline-block bg-yellow-500 hover:bg-yellow-600 text-white text-sm p-1 rounded" title="ver detalle del pedido">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center">
                                    <p class="text-2xl">No existen pedidos aprobados</p>
                                </td>
                            </tr>
                        @endforelse
